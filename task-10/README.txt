AMFOSS CSS Battle Solutions - README
====================================

This project contains my solutions to 5 CSS Battle tasks. 
Each task recreates a target design using only HTML <div> elements and CSS properties.
